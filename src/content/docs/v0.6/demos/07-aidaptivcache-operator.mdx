...
description: Learn how to install the aiDAPTIVCache Operator for Phison
  aiDAPTIVCache device support in Kubernetes
slug: v0.6/demos/07-aidaptivcache-operator
---
...
* Deploy fine-tuning jobs that utilize aiDAPTIVCache devices (see [Deploy aiDAPTIVCache Finetune](/v0.6/demos/08-aidaptivcache-finetune))
* Deploy inference services with aiDAPTIVCache acceleration (see [Deploy aiDAPTIVCache Inference](/v0.6/demos/09-aidaptivcache-inference))
