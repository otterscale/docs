...
slug: v0.6/demos/06-create-helm-chart
---
...
<Steps>
  ...
  4. **Push the chart to your registry**
     ...
     Once uploaded, navigate to the [Applications Store](/v0.6/service/applications/04-store/) to deploy the chart with your custom image.
</Steps>
