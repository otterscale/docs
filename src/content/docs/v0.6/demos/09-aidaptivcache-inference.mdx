...
slug: v0.6/demos/09-aidaptivcache-inference
---
...
<Aside type="caution">
  **Required**: Before using aiDAPTIVCache Inference, you must install the **aiDAPTIVCache Operator**.
  ...
  See [aiDAPTIVCache Operator](/v0.6/demos/07-aidaptivcache-operator) for installation instructions.
</Aside>
...
<Aside type="tip">
  For detailed instructions on creating and managing NFS File Systems in OtterScale, refer to the [Storage - File System](/v0.6/service/storage/04-file-system) documentation.
</Aside>
...
<LinkCard title="aiDAPTIVCache Finetune" description="Train and fine-tune LLM models" href="/demos/08-aidaptivcache-finetune" />

<LinkCard title="Storage - File System" description="Create and manage NFS File System" href="/service/storage/04-file-system" />

<LinkCard title="Services" description="Manage Kubernetes Services" href="/service/applications/02-services" />
