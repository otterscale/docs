...
slug: v0.6/service/repositories
---
...
<Tabs>
  <TabItem label="Docker Image">
    <Steps>
      ...
      3. After uploading, navigate to the [Applications Store](/v0.6/service/applications/04-store/) to update the Helm chart configuration to use your custom image:
  ...
  <TabItem label="Helm Chart">
    <Steps>
      ...
      3. After uploading, navigate to the [Applications Store](/v0.6/service/applications/04-store/) to deploy the Helm chart.
    </Steps>
  </TabItem>
</Tabs>
