...
| **Machine**       | The physical node (machine) hosting the VM instance.<br />**Expandable**: Click to view machine details.See [Machine Details](/v0.6/basic/machines/#machine-details). |
