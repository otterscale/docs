...
1. Navigate to the Scope management area.
2. Click on "Create Scope".
3. Enter the necessary details.
4. Confirm the creation.

## Managing Scopes

You can manage existing scopes, including updating settings and managing access.
